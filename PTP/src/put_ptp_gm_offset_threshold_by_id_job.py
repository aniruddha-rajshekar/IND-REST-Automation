...
def main():
    ...
    try:
        ...
        testbed = loader.load(test_path + '/put_ptp_gm_offset_threshold_by_id.yaml')
        ...
        for key1 in sorted(s8000.custom):
            ...
            run(testscript=test_path + '/ind_automation_ptp.py', testcasename=h_method, testcaseid=test_case_id,
        ...
        log.info('\tPUT PTP GM Offset Threshold By ID Job Failed: ' + str(msg))