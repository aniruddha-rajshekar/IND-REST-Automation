...
def main():
    ...
    try:
        ...
        testbed = loader.load(test_path + '/get_dlr_device_details_by_id.yaml')
        ...
        for key1 in sorted(s8000.custom):
            ...
            run(testscript=test_path + '/ind_automation_dlr.py', testcasename=h_method, testcaseid=test_case_id,
        ...
        log.info('\tGET DLR Device Details By ID Job Failed: ' + str(msg))