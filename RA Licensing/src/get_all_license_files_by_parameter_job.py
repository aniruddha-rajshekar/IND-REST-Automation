...
def main():
    ...
    try:
        ...
        testbed = loader.load(test_path + '/get_all_license_files_by_parameter.yaml')
        ...
        for key1 in sorted(s8000.custom):
            ...
            run(testscript=test_path + '/ind_automation_ftnm_licensing.py', testcasename=h_method, testcaseid=test_case_id,
        ...
        log.info('\tGET License Files By Parameter Job Failed: ' + str(msg))