...
def main():
    ...
    try:
        ...
        testbed = loader.load(test_path + '/get_topology_vlans_by_group.yaml')
        ...
        for key1 in sorted(s8000.custom):
            ...
            run(testscript=test_path + '/ind_automation_vlan_overlay.py', testcasename=h_method, testcaseid=test_case_id,
        ...
        log.info('\tGET Topology VLANS By Group Job Failed: ' + str(msg))